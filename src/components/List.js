...
const List = ({ songData }) => {
    ...
    // khi click vào 1 bài hát lấy id của nó guiwir về redux bài 18
    // gửi song data về redux xong redux truyền songdataencode id qua useSelector cho thằng player.js chính là cái 
    // cursongid
    return (
        <div
